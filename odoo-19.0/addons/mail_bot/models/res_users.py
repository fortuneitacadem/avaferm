...
class ResUsers(models.Model):
    ...
    def _init_odoobot(self):
        ...
        message = Markup("%s<br/>%s<br/><b>%s</b> <span class=\"o_odoobot_command\">:)</span>") % (
            _("Salom,"),
            _("Odoo chati xodimlarga samarali hamkorlik qilishga yordam beradi. Men sizga uning imkoniyatlarini kashf qilishda yordam berish uchun shu yerdaman."),
            _("Menga emoji yuborishga harakat qilib ko'ring")
        )
